        ...
        <div className={style.contenedor}>
            ...
            <div className={style.contenedorCreate}>
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div>
                        <button type="submit" disabled={input.name === ''||input.difficulty==='' || input.duration===''||input.season===''||input.countryId.length<0||errors.name||errors.difficulty||errors.duration||errors.season||errors.countryId}>Create</button>
                    </div>
            ...
            <div className={style.contenedorDelete}>
                <div >
                    ...
                    <form onSubmit={(event) => handleSubmitDelete(event)}>
                        ...
                        <div>
                            <button type="submit" disabled={delAct===''}>Delete</button>
                        </div>
                    </form>
                </div>
              {/* -----------------------Reload sector----------------------- */}
                <div>
                    <button onClick={reload}>Reset Form</button>
                </div>
            </div>
